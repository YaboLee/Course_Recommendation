...
function dv_baseHandler(){function G(b){try{var c=new URL(b);return!c.pathname||""==c.pathname||"/"==c.pathname}catch(f){}}function L(b){var c=window._dv_win,f=0;try{for(;10>f;){if(c[b]&&"object"===typeof c[b])return!0;if(c==c.parent)break;f++;c=c.parent}}catch(e){}return!1}function M(){var b="http:";"http:"!=window._dv_win.location.protocol&&(b="https:");return b}function H(b,c){var f=document.createElement("iframe");f.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+A();f.width=0;f.height=
0;f.id=c;f.style.display="none";f.src=b;return f}function B(b,c,f){f=f||150;var e=window._dv_win||window;if(e.document&&e.document.body)return c&&c.parentNode?c.parentNode.insertBefore(b,c):e.document.body.insertBefore(b,e.document.body.firstChild),!0;if(0<f)setTimeout(function(){B(b,c,--f)},20);else return!1}function N(b){var c=window._dv_win.dv_config=window._dv_win.dv_config||{};c.cdnAddress=c.cdnAddress||"cdn.doubleverify.com";return'<html><head><script type="text/javascript">('+function(){try{window.$dv=
window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(f){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+(b||"function() {}")+')("'+c.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function O(b){var c=null;try{if(c=b&&b.contentDocument)return c}catch(f){}try{if(c=b.contentWindow&&b.contentWindow.document)return c}catch(f){}try{if(c=window._dv_win.frames&&window._dv_win.frames[b.name]&&
window._dv_win.frames[b.name].document)return c}catch(f){}return null}function I(b){var c=0,f;for(f in b)b.hasOwnProperty(f)&&++c;return c}function P(b,c){a:{var f={};try{if(b&&b.performance&&b.performance.getEntries){var e=b.performance.getEntries();for(b=0;b<e.length;b++){var d=e[b],g=d.name.match(/.*\/(.+?)\./);if(g&&g[1]){var l=g[1].replace(/\d+$/,""),k=c[l];if(k){for(var m=0;m<k.stats.length;m++){var t=k.stats[m];f[k.prefix+t.prefix]=Math.round(d[t.name])}delete c[l];if(!I(c))break}}}}var h=
f;break a}catch(w){}h=void 0}if(h&&I(h))return h}function Q(b,c){var f,e=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(d){var g=window._dv_win.$dvbs;if(g){var l=c?"https:":M();f=d.ImpressionID;g.tags.add(d.ImpressionID,b);g.tags[d.ImpressionID].set({tagElement:b.script,impressionId:d.ImpressionID,dv_protocol:b.protocol,protocol:l,uid:b.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});b.script&&b.script.dvFrmWin&&(b.script.dvFrmWin.$uid=d.ImpressionID,
g.messages&&g.messages.startSendingEvents&&g.messages.startSendingEvents(b.script.dvFrmWin,d.ImpressionID));(function(){function c(){var f=window._dv_win.document.visibilityState;"prerender"===e&&"prerender"!==f&&"unloaded"!==f&&(e=f,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(b,c))}if("prerender"===e)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbs.registerEventCall(d.ImpressionID,
...
f=b.innerHTML.replace(e,"\x3c/script>");b=d(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:f}};return d(b)}function J(b,c,f,e,d,g,l,k,m,t,h,w){void 0==c.dvregion&&(c.dvregion=0);try{e.depth=S(e);var p=T(e);var n="&aUrl="+encodeURIComponent(p.url);var q="&aUrlD="+p.depth;var v=e.depth+d;g&&e.depth--}catch(u){q=n=v=e.depth=""}void 0!=c.aUrl&&(n="&aUrl="+c.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var r=1;break a}}catch(u){}r=
0}g=function(){function b(c){d++;var f=c.parent==c;return c.mraid||f?c.mraid:20>=d&&b(c.parent)}var c=window._dv_win||window,d=0;try{return b(c)}catch(x){}}();d=c.script.src;r="&ctx="+(dv_GetParam(d,"ctx")||"")+"&cmp="+(dv_GetParam(d,"cmp")||"")+"&plc="+(dv_GetParam(d,"plc")||"")+"&sid="+(dv_GetParam(d,"sid")||"")+"&advid="+(dv_GetParam(d,"advid")||"")+"&adsrv="+(dv_GetParam(d,"adsrv")||"")+"&unit="+(dv_GetParam(d,"unit")||"")+"&isdvvid="+(dv_GetParam(d,"isdvvid")||"")+"&uid="+c.uid+"&tagtype="+(dv_GetParam(d,
...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:26,vdcd:c.res,err:b}}catch(f){return{vdcv:26,vdcd:"0",err:b}}}function S(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function T(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var f,e=1,d=0;0<e&&100>d;){try{if(d++,f=c.shift(),e--,0<f.win.location.toString().length&&f.win!=b)return 0==f.win.document.referrer.length||0==f.depth?{url:f.win.location,depth:f.depth}:{url:f.win.document.referrer,
depth:f.depth-1}}catch(k){}var g=f.win.frames.length;for(var l=0;l<g;l++)c.push({win:f.win.frames[l],depth:f.depth+1}),e++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function X(){var b=window._dv_win[F("=@42E:@?")][F("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var f=0;f<b.length;f++)c[f+1]=b[f];return c.reverse().join(",")}return null}function F(b){new String;var c=new String,f;for(f=0;f<b.length;f++){var e=
b.charAt(f);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=d&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));c+=e}return c}function A(){return Math.floor(1E12*(Math.random()+""))}function U(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,
...
b=void 0!=c.style.textShadow}catch(f){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(f){return 0}}function Y(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},f=function(b,c){return function(){return b.apply(c,arguments)}},e="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?
document.createElement(arguments[0]):e?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},g=["Moz","O","ms","Webkit"],l=["moz","o","ms","webkit"],k={style:d("modernizr").style},m=function(b,c){function f(){g&&(delete k.style,delete k.modElem)}var e;for(e=["modernizr","tspan","samp"];!k.style&&e.length;){var g=!0;k.modElem=d(e.shift());k.style=k.modElem.style}var l=b.length;for(e=0;e<l;e++){var h=b[e];~(""+h).indexOf("-")&&
(h=cssToDOM(h));if(void 0!==k.style[h])return f(),"pfx"==c?h:!0}f();return!1},t=function(b,c,d){var e=b.charAt(0).toUpperCase()+b.slice(1),k=(b+" "+g.join(e+" ")+e).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(k,c);k=(b+" "+l.join(e+" ")+e).split(" ");for(var h in k)if(k[h]in c){if(!1===d)return k[h];b=c[k[h]];return"function"===typeof b?f(b,d||c):b}return!1};c(0,!0);c(1,t("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,t("shapeOutside",
"content-box",!0));return b}catch(h){return 0}}function K(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(f){}return b}function Z(){try{var b=K(),c=0,f=0,e=function(b,d,e){e&&(c+=Math.pow(2,b),f+=Math.pow(2,d))},d=b.document;e(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));e(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));e(15,2,b.zpz&&
b.zpz.createPlayer);e(15,3,b.vdApp&&b.vdApp.createPlayer);e(15,4,d.querySelector('body>div[class="z-z-z"]'));e(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));e(17,6,b==b.top&&""==d.title?(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);e(17,7,d.querySelector('script[src*="sitewebvideo.com"]'));e(17,8,b.InitPage&&b.cef&&b.InitAd);e(17,9,b==b.top&&""==d.title?(a=
d.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);e(17,10,b==b.top&&""==d.title&&b.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);e(17,11,null!=b.clickplayer&&null!=b.checkRdy2);e(19,12,b.instance&&b.inject&&d.querySelector('path[id="cp-search-0"]'));e(20,13,function(){try{if(b.top==b&&0<b.document.getElementsByClassName("asu").length)for(var c=
b.document.styleSheets,d=0;d<c.length;d++)for(var f=b.document.styleSheets[d].cssRules,e=0;e<f.length;e++)if("div.kk"==f[e].selectorText||"div.asu"==f[e].selectorText)return!0}catch(w){}}());a:{try{var g=null!=d.querySelector('div[id="kt_player"][hiegth]');break a}catch(k){}g=void 0}e(21,14,g);a:{try{var l=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');break a}catch(k){}l=void 0}e(22,15,l);return{f:c,s:f}}catch(k){return null}}function aa(){try{var b="&fcifrms="+window.top.length;
window.history&&(b+="&brh="+window.history.length);var c=K(),f=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{f.cookie&&(b+="&fcl="+f.cookie.length)}catch(e){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));f.querySelectorAll&&(b+="&fec="+f.querySelectorAll("*").length)}return b}catch(e){return""}}
function W(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),h=Array(e),g=0;g<e;g++){h[g]=Array(16);for(var p=0;16>p;p++)h[g][p]=b.charCodeAt(64*g+4*p)<<24|b.charCodeAt(64*g+4*p+1)<<16|b.charCodeAt(64*g+4*p+2)<<8|b.charCodeAt(64*g+4*p+3)}h[e-1][14]=8*(b.length-1)/Math.pow(2,
32);h[e-1][14]=Math.floor(h[e-1][14]);h[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;p=4023233417;var n=2562383102,q=271733878,v=3285377520,r=Array(80);for(g=0;g<e;g++){for(var u=0;16>u;u++)r[u]=h[g][u];for(u=16;80>u;u++)r[u]=c(r[u-3]^r[u-8]^r[u-14]^r[u-16],1);var D=b;var y=p;var x=n;var z=q;var A=v;for(u=0;80>u;u++){var E=Math.floor(u/20),B=c(D,5);a:{switch(E){case 0:var C=y&x^~y&z;break a;case 1:C=y^x^z;break a;case 2:C=y&x^y&z^x&z;break a;case 3:C=y^x^z;break a}C=void 0}E=B+C+A+f[E]+r[u]&4294967295;
A=z;z=x;x=c(y,30);y=D;D=E}b=b+D&4294967295;p=p+y&4294967295;n=n+x&4294967295;q=q+z&4294967295;v=v+A&4294967295}return d(b)+d(p)+d(n)+d(q)+d(v)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}function f(){try{return!!window.localStorage}catch(g){return!0}}function e(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);
c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(k){}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",c()?"1":"0"]);d.push(["hls",f()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",
e()]);return b(d.join("=!!!="))}catch(g){return null}}this.createRequest=function(){var b=!1,c=window._dv_win,f=0,e=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,f++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(v){b=!1}a:{try{var g=c.$sf;break a}catch(v){}g=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(G(b)){a:{try{var l=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();
break a}catch(v){}l=void 0}if(l&&!G(l)&&0==l.indexOf(b)){b=l;var k=!0}}e=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();l=d.script;this.dv_script_obj=d;this.dv_script=l;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(l);
var m=l.src;this.dvOther=0;this.dvStep=1;var t=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();d=window.parent.postMessage&&window.JSON;var h=!0,w=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)w=!0;if(d&&0==w)try{var p=H(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+t);h=B(p)}catch(v){}p=
{};try{w=/[\?&]([^&]*)=([^&#]*)/gi;for(var n=w.exec(m);null!=n;)"eparams"!==n[1]&&(p[n[1]]=n[2]),n=w.exec(m);var q=p}catch(v){q=p}q.perf=this.perf;q.uid=t;q.script=this.dv_script;q.callbackName="__verify_callback_"+q.uid;q.tagObjectCallbackName="__tagObject_callback_"+q.uid;q.tagAdtag=null;q.tagPassback=null;q.tagIntegrityFlag="";q.tagHasPassbackFlag="";0==(null!=q.tagformat&&"2"==q.tagformat)&&(n=R(q.script),q.tagAdtag=n.tagAdTag,q.tagPassback=n.tagPassback,n.isBadImp?q.tagIntegrityFlag="&isbadimp=1":
n.hasPassback&&(q.tagHasPassbackFlag="&tagpb=1"));(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?p="https:":(p=q.script.src,m="http:",t=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=p.match("^https")||"https"!=t&&"http"==t||(m="https:"),p=m);q.protocol=p;q.ssl="0";"https:"===q.protocol&&(q.ssl="1");p=q;(m=window._dv_win.dvRecoveryObj)?("2"!=p.tagformat&&
(m=m[p.ctx]?m[p.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&p.tagAdtag?document.write(p.tagAdtag):2===m&&p.tagPassback&&document.write(p.tagPassback)),p=!0):p=!1;if(p)return{isSev1:!0};this.dvStep=2;Q(q,n);l=l&&l.parentElement&&l.parentElement.tagName&&"HEAD"===l.parentElement.tagName;this.dvStep=3;return J(this,q,b,c,f,e,d,h,l,n,k,g)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);
try{if("1"!=dv_GetParam(b,"foie")){var f=N(this.dv_script_obj&&this.dv_script_obj.injScripts),e=H("about:blank");e.id=e.name;var d=e.id.replace("iframe_","");e.setAttribute&&e.setAttribute("data-dv-frm",d);B(e,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=e.contentWindow){var l=b;break a}}catch(t){}try{if(b=window._dv_win.frames&&window._dv_win.frames[e.name]){l=b;break a}}catch(t){}l=null}g.dvFrmWin=l}var k=O(e);if(k)k.open(),k.write(f);else{try{document.domain=document.domain}catch(t){}var m=
encodeURIComponent(f.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));e.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+m+"');})()"}}}catch(t){f=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(f+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(t)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=
J);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"113"}};
